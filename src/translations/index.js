export const translations = {
  ru: {
    ...
    aboutText1:
      "Департамент информационных технологий занимается разработкой и внедрением современных цифровых решений для государственных орган��в Республики Казахстан.",
    aboutText2:
    ...
    digitalDocsDesc: "Безопа��ное хранение и управление цифровыми документами",
    appStore: "App Store",
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "Через приложение вы можете получить различные справки, выписки и другие документы, такие как справка о со��таве семьи, выписка из земельного кадастра и другие.",
      },
      {
    ...
    timeline: {
      ...
      year2019: {
        title: "Релиз нового ��риложения eGov Mobile",
        description:
      ...
      year2024: {
        ...
        description:
          "Углубление интеграции с ИИ-платформами (НПИ). Начало работы над визитной страницей ИС МГОВ и Telegram-инфраструктурой. После июля 2024 eGov Business расширил экосистему мобильного правительства, позволив юрлицам эффективно получать госуслуги с мобильных устройств.",
      },
      year2025: {
    ...
    statistics: {
      ...
      egovMobileUsers: "Пользователи прилож��ния eGov Mobile",
  ...
  kk: {
    ...
    heroSubtitle:
      "Тиімді мемлекеттік басқару және азаматтарға сапалы қызмет көр��ету үшін инновациялық шешімдер",
    ...
    errorMessage:
      "Жіберу кезінде қате орын алды. Әрекетті кей��нірек қайталаңыз.",
    ...
    timeline: {
      ...
      year2023: {
        ...
        description:
          "«Дипломдарды тану» сервисін енгізу. UX/UI жақсарту, барлық құрылғы түрлеріне бейімделу. eGov Mobile архитектурасын микросервистік тәсілге сә��кес жаңарту.",
      },
      year2024: {
        title: "ЖасНТИ платформаларымен интеграция",
        description:
          "ЖасНТИ платформаларымен интеграцияны тереңдету. ММОЖ АЖ-ның визиттік беті және Telegram-инфрақұрылымы бойынша жұмысты бастау. 2024 жылдың шілдесінен кейін eGov Business заңды тұлғаларға мобильді құрылғылардан мемлекеттік қызметтерді тиімді алуға мүмкіндік беру арқылы мобильді үкімет экожүйесін кеңейтті.",
      },
      year2025: {
    ...
    statistics: {
      title: "Статистика",
      description:
        "«Мобильді үкімет» депа��таменті азаматтар мен бизнес үшін мемлекеттік қызметтерге қол жеткізуді жеңілдетуге арналған сандық шешімдерді белсенді түрде енгізуде. Төменде 2025 жылғы негізгі көрсеткіштер келтірілген:",
      ...
      conclusion:
        "Бұл деректер «Мобильді үкі��ет» департаменті жүзеге асыратын шешімдердің тиімділігін, сондай-ақ мемлекет пен халықтың өзара әрекеттестігінің сандықтандыру деңгейінің жоғары екенін растайды.",
    },
