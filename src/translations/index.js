export const translations = {
  ...
  kk: {
    ...
    featuresSection: {
      title: "Сіз білесіз бе, енді мүмкін…",
      features: [
        "…анықтаманы (соттылық, тіркеу, денсаулық жағдайы) смартфоннан — ХҚКО-ға кезексіз алуға болады?",
        "…жеке куәлікті, жүргізуші куәлігін немесе дипломды электронды түрде көрсетуге болады — және бұл ресми түрде қабылданады?",
        "…нотариустан сенімхат рәсімдеп, кеңес алуға болады — үйден шықпай, бейнеқоңырау арқылы?",
        "…eOtinish арқылы мемлекеттік органға өтінішті бірнеше минутта — қағазсыз, тіркеусіз және бармай-ақ беруге болады?",
        "…салықтарды бақылап, екі рет басу арқылы төлеуге болады — салық әмиянынан тікелей?",
        "…мектепті, ЖОО-ны немесе емхананы таңдап, өтініш беріп, оны ЭЦҚ-мен қол қоюға болады — мобильді қосымшада?",
        "…цифрлық анықтаманың дайын болғанын біліп, жаңа құжаттар туралы ескерту алуға болады — push-хабарламалар арқылы?",
        "…жеке мәліметтерге жұмыс берушіге қағазсыз қолжетімділік беруге болады — QR-код жіберу жеткілікті?",
        "'Халық қатысатын бюджет' арқылы өз аулаңызды абаттандыруға дауыс беруге болады?",
        "…ЭЦҚ-ны тікелей қосымшада рәсімдеуге болады — биометрия арқылы, флешкасыз?",
        "…Ұлттық Құрылтайға қосылып, ұсыныстар беріп, бастамаларға дауыс беруге болады?",
        "…ЦОН-нан бейнебайланыс арқылы кеңес алуға болады — тікелей телефоннан?"
      ]
    },
  },
  en: {
